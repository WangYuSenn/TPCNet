...
def save_mask(pred_masks, save_base_path, video_name_list):
    ...
    pred_masks *= 255
    # print('pre_mask', pred_masks.shape)
    ...
    for idx in range(bs):
        ...
        # print('one_video_masks', one_video_masks.shape)
        # print('range(len(one_video_masks))', range(len(one_video_masks)))
        for video_id in range(len(one_video_masks)):
            one_mask = one_video_masks[video_id]
            # print('one_mask', one_mask.shape)
...
def save_raw_img_mask(anno_file_path, raw_img_base_path, mask_base_path, split='avs_test', r=0.5):
